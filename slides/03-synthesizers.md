...
**Jonny Greenwood（Radiohead）** 是當代最有名的 ondist。
1999 年錄 *Kid A* / *Amnesiac* 期間，他在巴黎買到一台。

在編曲裡它不是特效，是**一條會滑動的人聲式旋律線**——
《Pyramid Song》《How to Disappear Completely》都聽得到。

<p class="vidlinks">▶ <a href="https://www.youtube.com/watch?v=lcmbLpCXUGk">Radiohead - Pyramid Song（巴黎現場，2001 年 4 月）</a></p>

Note:
挑這支是因為它的時間點很剛好。Greenwood 2000 年巡演帶的是真的 Ondes，
但他一直擔心這台脆弱的古董在路上被弄壞，於是委託 Analogue Systems 做替代品。
French Connection 的原型 2001 年 4 月展示、5 月交機——這場演出正好卡在交界。
所以不必斷言畫面上是哪一台，重點是接下來那張投影片講的事。

--

## 把「介面」跟「發聲」拆開

真的 Ondes 太脆弱，不敢帶上路。Greenwood 因此委託 **Analogue Systems**
做了 **French Connection**：2001 年交機，2001–2012 的巡演都用它。

它**只複製介面**——那條戴戒指的絲線、那個音量鍵，
輸出的是 **CV 控制電壓**，真正發聲的是後面的模組合成器。

> 1928 年的演奏介面，接上 1964 年的電壓控制，在 2001 年的搖滾現場運作。
> **介面可以跟發聲機制分開，各自演化。**

Note:
這張是這一節真正要傳達的觀念，也接得上 3.9 節「介面的歷史」。
Ondes 之所以值得學，不只是它的聲音，而是它證明了「連續控制的介面」有存在價值——
鍵盤不是唯一解。French Connection 把這件事推到極致:介面留下來，發聲機制整個換掉。
學生在第 8 章接 [osc~] 的時候，可以回頭想這張投影片：你要用什麼東西去控制那個頻率？
...
## VCV Rack（2017）：兩條線撞在一起

「合成器變成軟體」和「模組化復興」，在這裡交會。

把 Eurorack 整個搬進螢幕：一樣的機櫃、一樣的面板、一樣要拉線接 CV。

| | |
|---|---|
| **Rack Free** | 開源、免費，Win / macOS / Linux |
| **Rack Pro** | 149 美元，可當 VST / AU / CLAP 外掛 |
| 模組數 | 內建 30+、官方移植 170+、社群庫 2000+ |

<p class="vidlinks">▶ <a href="https://vcvrack.com/Rack">vcvrack.com</a></p>

Note:
寫這版時是 2.6.6，Rack 3 在開發中。
「官方移植」的意思是真實 Eurorack 廠商自己做的軟體版，所以你可以先在螢幕上試一顆
實體要價數百美元的模組再決定買不買。
對這門課最直接的用處是零成本真正接一次模組化系統。

--

## 它拆掉了自己的兩個理由

前一張說人們回頭買硬體有三個理由。VCV Rack 讓其中兩個消失了：
...
Eurorack 賣的從來不只是聲音。三個理由裡，真正買不到的是身體的部分。

Note:
這張是要讓學生自己想:既然軟體什麼都能做,為什麼硬體還賣得動?
答案不在音質,在互動方式。這個問題會在 3.9 節「介面的歷史」再出現一次。
...
3. 加一個 LFO 到濾波器截止頻率（8.4 節），做出自動掃頻
