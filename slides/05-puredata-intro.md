...
> 對沒有程式背景的人來說，門檻低很多，它在藝術與設計領域普及的原因就在這裡。
...
> 解法在第 6 章之後：子補丁、抽象、`[send]`／`[receive]`、以及**寫註解**。
...
Pure Data 用 **BSD 授權**釋出，這是一種相當寬鬆的自由軟體授權，允許幾乎不受限制地使用、修改與再散布。

**取得原始碼**

- 官方網站 <https://puredata.info>
- GitHub：<https://github.com/pure-data/pure-data>

**參與開發**

- 在 GitHub 的 Issues 回報問題或提改進建議
- 用 Pull Request 提交程式碼，由核心團隊審查合併
- 開發並分享自己的擴充與外掛
...
Pd 的社群包含開發者、音樂家、藝術家與教育者，透過幾種方式運作：

- **論壇與郵件列表**：交流經驗、解決問題、討論新功能
- **會議與工作坊**：定期舉辦，提供面對面交流的機會
- **文件與教學**：社群貢獻了大量文件、教學與範例

這些資源是 Pd 二十多年來持續發展的原因，也是它在資源相對少的情況下仍然好用的原因。
