...
> **bang 帶的不是資料，而是時機。** 所有「什麼時候發生」的邏輯都由它驅動。
...
> 延遲時間長短決定它是梳狀／鑲邊／合唱／回聲——對照表見第 7 章，兩邊通用。
...
長笛 + 即時電子。在 **IRCAM** 以 4X 工作站完成，**Max 就是在這個現場誕生的**。
...
他們不是用 Max 播放做好的曲子，而是寫一套會自己產生音樂的系統，現場讓它跑。演出者更接近「調整參數的園丁」。
