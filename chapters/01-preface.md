...
完整的歷史、每個時代的技術限制如何長出風格，以及怎麼用 Pure Data 自己做一套會回應玩家狀態的音樂系統，見[第 4 章 電子遊戲音樂的歷史](04-game-audio.md)。
...
可嵌入其他程式（Pd 獨有）：Pure Data 可以透過 **libpd** 嵌進 App、遊戲引擎與行動裝置。2008 年的《Spore》就是把 Pd 整個放進遊戲裡跑即時生成的音樂——這讓 Pd 的學習成果不只停留在自己的電腦上，而能變成別人手上會跑的產品（見[第 4 章](04-game-audio.md)）。
