...
聲音藝術的討論常常止步於美術館與音樂廳，但二十世紀後半規模最大、被最多人親身經歷的互動聲音系統，其實是**電子遊戲**。

從 1972 年《Pong》——聲音是工程師從電路裡「找」出來的副產品——到 1978 年《Space Invaders》那段**會隨敵人減少而加快的四音循環**，遊戲很早就做到了一件聲音藝術一直在追求的事：

> **聲音不是背景，而是系統狀態的聽覺化；聽的人同時也是造成聲音改變的人。**

這條線一路走過方波晶片、FM 合成、取樣與 CD、iMUSE 的無縫轉換，最後在 2008 年的《Spore》繞回本課程的核心工具——那款遊戲**把 Pure Data 整個嵌進遊戲裡**跑即時生成的音樂。這個做法後來成為 **libpd**，讓 Pd 補丁可以直接嵌進 App、遊戲與行動裝置。

換句話說：**你在這門課學到的東西，有一條非常直接的路通往遊戲產業。**

完整的歷史、每個時代的技術限制如何長出風格，以及怎麼用 Pure Data 自己做一套會回應玩家狀態的音樂系統，見[第 7 章 電子遊戲音樂的歷史](07-game-audio.md)。
...
可嵌入其他程式（Pd 獨有）：Pure Data 可以透過 **libpd** 嵌進 App、遊戲引擎與行動裝置。2008 年的《Spore》就是把 Pd 整個放進遊戲裡跑即時生成的音樂——這讓 Pd 的學習成果不只停留在自己的電腦上，而能變成別人手上會跑的產品（見[第 7 章](07-game-audio.md)）。
